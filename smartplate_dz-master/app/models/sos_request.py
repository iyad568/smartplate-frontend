"""
SOS Request model for SmartPlate emergency assistance system.
"""
...
class SOSRequest(Base):
    """SOS emergency assistance request model."""
    ...
    emergency_description: Mapped[str] = mapped_column(Text, nullable=False)
